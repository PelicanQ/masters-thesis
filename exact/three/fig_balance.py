...
c1 = ax1.pcolormesh(o2prim_grid, d13_grid, balance_zzz, cmap=cmap, norm=norm, rasterized=True)
ax1.set_xlim(-6, 14)

ax1.set_ylabel(r"$\Delta_{13}$ [$E_C$]")

c2 = ax2.pcolormesh(o2prim_grid, d13_grid, balance_zz, cmap=cmap, norm=norm, rasterized=True)
...
fig.savefig("figs/balance.pdf", dpi=300, bbox_inches="tight")
