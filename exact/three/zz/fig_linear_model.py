...
def predict_fig():
    ...
    fig, (ax1, ax2) = plt.subplots(2, 1, sharex=True, sharey=True, constrained_layout=True, figsize=(5.9, 5.9 * 3 / 4))
    ...
    ax2.pcolormesh(o2primgrid, detunegrid, rela, vmin=0.01, vmax=0.1, cmap=cmap, rasterized=True)
    ...
    fig.savefig("figs/linear-model-error.pdf", dpi=300, bbox_inches="tight")
