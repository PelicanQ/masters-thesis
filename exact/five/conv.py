...
NN = np.arange(8, 16, 1)
MM = np.arange(10, 17, 1)
C = 100
# order Ej1 Ej2 Ej3 Eint12 Eint23 Eint13
points = [
    (50, 50, 50, 50, 50, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3),
    (50, 50, 50, 50, 50, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5),
    (50, 55, 60, 45, 65, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3),
    (50, 55, 60, 45, 65, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5),
]

num_levels = 55  # 0-3 excitation subspace
...
np.save("relerr5T8_16_10_17", maxed)
...
plt.colorbar()
plt.title(f"Relative error 5T, C={C}")
