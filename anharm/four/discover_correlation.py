...
# )
e = H.zzexpr("1110") - ((H.zzexpr("1100") + H.zzexpr("0110") + H.zzexpr("1010")))
e = H.split_deltas(e)
...
def calculate(g12, g23, g34, d34):
    Z = f(-1, -1, -1, g12, g23, g34, d12, d23, d34)
    # Z = f(-1, -1, -1, g12, g23, g13, d12, d23)
    Z = np.abs(Z)
    return Z


ax = make_discover(["g12", "g23", "g34", "d34"], [g12, g23, g34, d34], d12, d23, calculate, colors.LogNorm(1e-2, 1e0))
ax.set_xlabel("delta 12")
ax.set_ylabel("delta 23")
ax.set_title(f"|ZZZZ - all ZZ's| [-alpha]")
plt.show()
