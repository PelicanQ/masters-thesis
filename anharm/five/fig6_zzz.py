...
print(vals)
plt.pcolormesh(o2prims, dd13_grid, vals, norm=Norm(1e0), cmap=OrBu_colormap())
plt.title(
    f"$ZZZ_{{123}}$ $g_{{12}}$={g01} $g_{{23}}$={g12} $g_{{13}}$={g02} $g_{{34}}$={g23} $g_{{35}}$={g24} $\Delta_{{34}}$={d23} $\Delta_{{45}}$={d34}"
)
