...
slid_g12 = makeslid(ax_slid_g12, "g12", 0)
slid_g23 = makeslid(ax_slid_g23, "g23", 0)
slid_g13 = makeslid(ax_slid_g13, "g13", 0)
slidw1 = makeslid(ax_slidw1, "w1", w1_init)
slidw2 = makeslid(ax_slidw2, "w2", w2_init)
slidw3 = makeslid(ax_slidw3, "w3", w3_init)
...
def update(val):
    ...
    # vecline1.set_zdata([-vecs[1, 0], vecs[1, 0]])
    # vecline2.set_xdata([-vecs[0, 1], vecs[0, 1]])
    # vecline2.set_ydata([-vecs[1, 1], vecs[1, 1]])
    # vecline3.set_xdata([-vecs[0, 1], vecs[0, 1]])
    # vecline3.set_ydata([-vecs[1, 1], vecs[1, 1]])
    # line1bare.set_color(colors[0])
    # line2bare.set_color(colors[1])
    # line3bare.set_color(colors[2])
    # vecline1bare.set_color(colors[0])
    # vecline2bare.set_color(colors[1])
    # vecline3bare.set_color(colors[2])

    # line1.set_ydata([vals[0], vals[0]])
    # line2.set_ydata([vals[1], vals[1]])
    # line3.set_ydata([vals[2], vals[2]])
